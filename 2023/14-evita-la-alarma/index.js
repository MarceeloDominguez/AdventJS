...
// Sin embargo, las casas tienen un sistema de seguridad conectado entre casas adyacentes, por lo que no puede dejar los regalos en dos casas seguidas, o se activará la alarma que alertará a los niños.
...
function maxGifts(houses) {
  ...
  for (let i = 2; i < houses.length; i++) {
    const temp = currMax;
    currMax = Math.max(currMax, prevMax + houses[i]);
    prevMax = temp;
  }
